    ...
    public static void registerTrades(VillagerTradesEvent event) {
        ...
        if (Create_better_villagers.CONFIG.common.ENABLE_ANDESITE_WORKER) {
            if (event.getType() == ModVillagers.ANDESITE_WORKER.value()) {
                ...
                event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 1), new ItemStack(AllItems.ANDESITE_ALLOY, 4), 3, 5, 0.07f));
                //LEVEL 2
                ...
                //LEVEL 3
                event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 4), new ItemStack(AllItems.IRON_SHEET, 6), 3, 5, 0.07f));
                event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 2), new ItemStack(AllItems.ROSE_QUARTZ, 4), 3, 5, 0.05f));
                //LEVEL 4
                event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Items.EMERALD, 4), new ItemStack(AllItems.FILTER, 2), 3, 5, 0.05f));
                event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Items.EMERALD, 5), new ItemStack(AllItems.ATTRIBUTE_FILTER, 2), 3, 5, 0.05f));
                //LEVEL 5
                event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 1), new ItemStack(AllItems.PROPELLER, 2), 3, 5, 0.05f));
                event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 1), new ItemStack(AllItems.WHISK, 2), 3, 5, 0.05f));
        ...
        if (Create_better_villagers.CONFIG.common.ENABLE_BRASSWORKER) {
            if (event.getType() == ModVillagers.BRASSWORKER.value()) {
                ...
                event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 1), new ItemStack(AllItems.BRASS_INGOT, 2), 5, 4, 0.07f));
                ...
                event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Items.EMERALD, 3), new ItemStack(AllItems.BRASS_INGOT, 5), 3, 5, 0.05f));
                //LEVEL 5
                ...
                event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 5), new ItemStack(AllItems.BRASS_HAND, 2), 4, 5, 0.05f));
        ...
        if (Create_better_villagers.CONFIG.common.ENABLE_COPPERWORKER) {
            if (event.getType() == ModVillagers.COPPERWORKER.value()) {
                ...
                event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 2), new ItemStack(AllItems.COPPER_SHEET, 3), 5, 5, 0.07f));
        ...
        if (Create_better_villagers.CONFIG.common.ENABLE_MINER) {
            if (event.getType() == ModVillagers.MINER.value()) {
                ...
                event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 2), new ItemStack(AllBlocks.LIMESTONE, 7), 10, 5, 0.07f));
                event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 2), new ItemStack(AllBlocks.DEPOT, 2), 10, 5, 0.07f));
                //LEVEL 2
                event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 2), new ItemStack(AllItems.ZINC_INGOT, 4), 10, 5, 0.05f));
                event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 6), new ItemStack(AllBlocks.CRUSHING_WHEEL, 2), 10, 5, 0.05f));
                //LEVEL 3
                ...
                //LEVEL 4
                event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Items.EMERALD, 3), new ItemStack(AllItems.SWEET_ROLL, 4), 10, 5, 0.05f));
                event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Items.EMERALD, 3), new ItemStack(AllItems.BUILDERS_TEA, 2), 10, 5, 0.05f));
                //LEVEL 5
                event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 5), new ItemStack(AllItems.ZINC_INGOT, 8), 4, 5, 0.05f));
